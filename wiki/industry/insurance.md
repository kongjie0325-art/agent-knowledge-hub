...
> Sources: kb/industry/insurance.md; 2026-06-12
> Raw: [insurance](../../raw/industry/insurance.md)
...
- **[aws-samples/sample-agentic-insurance-claims-processing-eks](https://github.com/aws-samples/sample-agentic-insurance-claims-processing-eks)** (-⭐): AWS 出品，生产级自主 Agentic 保险理赔系统，基于 LangGraph + K8s
- **[Snowflake-Labs/sfguide-insurance-claims-agent](https://github.com/Snowflake-Labs/sfguide-insurance-claims-agent)** (-⭐): Snowflake Cortex 驱动的保险理赔 Agent，整合结构化与非结构化数据
- **[sap156/AI-Claims-Agent-LangGraph](https://github.com/sap156/AI-Claims-Agent-LangGraph)** (-⭐): LangGraph 多 Agent 工作流，自动化理赔评估
- **[aws-samples/sample-quicksuite-chatagent-insurance-underwriting](https://github.com/aws-samples/sample-quicksuite-chatagent-insurance-underwriting)** (-⭐): Amazon Nova Lite 2.0 企业保险核保 MCP 服务器
- **[aws-solutions-library-samples/guidance-for-omnichannel-claims-processing-powered-by-generative-ai-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-omnichannel-claims-processing-powered-by-generative-ai-on-aws)** (-⭐): AWS 全渠道理赔处理生成式 AI 解决方案
- **[mallahyari/ml-practical-usecases](https://github.com/mallahyari/ml-practical-usecases)** (-⭐): 含保险行业 ML 实践案例（风险评估、欺诈检测）
- **[ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** (61.7k⭐): Claude 技能大全，含保险理赔/核保/客户服务技能
- **[ARUNAGIRINATHAN-K/awesome-ai-agents-2026](https://github.com/ARUNAGIRINATHAN-K/awesome-ai-agents-2026)** (87⭐): 2026 AI Agent 精选，含保险/金融服务 Agent 分类
- **[ashishpatel26/500-AI-Agents-Projects](https://github.com/ashishpatel26/500-AI-Agents-Projects)** (-⭐): 500+ AI Agent 项目，含保险领域用例
- **[mergisi/awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents)** (-⭐): OpenClaw Agent 精选，含保险客服/理赔 Agent
- **[VoltAgent/voltagent](https://github.com/VoltAgent/voltagent)** (-⭐): VoltAgent 框架，官方提供保险 Agent 用例（理赔/核保/欺诈检测）
- **[OasisLMF/OasisLMF](https://github.com/OasisLMF/OasisLMF)** (-⭐): 开源保险精算建模框架，用于巨灾风险分析
- **[open-insurance/insurance-standards](https://github.com/open-insurance/insurance-standards)** (-⭐): 保险行业标准与规范集合
- **[langgenius/dify](https://github.com/langgenius/dify)** (142k⭐): 开源 LLM 应用开发平台，支持保险应用快速搭建
- **[langchain-ai/langchain](https://github.com/langchain-ai/langchain)** (138k⭐): 最流行的 LLM 应用框架，广泛用于保险 Agent 构建
