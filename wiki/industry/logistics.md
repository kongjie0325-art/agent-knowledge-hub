...
> Sources: kb/industry/logistics.md; 2026-06-12
> Raw: [logistics](../../raw/industry/logistics.md)
...
- **[rh-ai-quickstart/ai-supply-chain-agent](https://github.com/rh-ai-quickstart/ai-supply-chain-agent)** (-⭐): AI 供应链智能仪表盘，结合实时物流模拟与 RAG 聊天机器人
- **[Appointat/Responsive-AI-Clusters-in-Supply-Chain](https://github.com/Appointat/Responsive-AI-Clusters-in-Supply-Chain)** (-⭐): 响应式 AI 集群系统，用于实时自适应供应链协调与优化
- **[Bhardwaj-Saurabh/OmniSupply-AI-Multi-Agent-Supply-Chain-Intelligence-Platform](https://github.com/Bhardwaj-Saurabh/OmniSupply-AI-Multi-Agent-Supply-Chain-Intelligence-Platform)** (-⭐): 多智能体供应链智能平台，整合供应商、采购、交付和成本数据
- **[MiChaelinzo/LogiFlow-AI-Intelligent-Logistics-Management-Platform](https://github.com/MiChaelinzo/LogiFlow-AI-Intelligent-Logistics-Management-Platform)** (-⭐): 基于 TiDB Serverless 向量搜索和多步骤 AI Agent 的智能物流管理平台
- **[fleetbase/fleetbase](https://github.com/fleetbase/fleetbase)** (-⭐): 模块化物流与供应链操作系统（LSOS），支持管理、规划、优化和运营控制
- **[aws-samples/sample-amazon-bedrock-property-inspection-agent](https://github.com/aws-samples/sample-amazon-bedrock-property-inspection-agent)** (-⭐): 基于 Amazon Bedrock 的 AI Agent 示例，可用于物流设施检测与合规检查
- **[aws-samples/sample-agentic-ai-robot](https://github.com/aws-samples/sample-agentic-ai-robot)** (-⭐): Agentic AI 机器人：工业安全监控与控制，可应用于仓储安全场景
- **[mallahyari/ml-practical-usecases](https://github.com/mallahyari/ml-practical-usecases)** (-⭐): 包含 DoorDash 等物流案例的机器学习实践用例集
- **[ARUNAGIRINATHAN-K/awesome-ai-agents-2026](https://github.com/ARUNAGIRINATHAN-K/awesome-ai-agents-2026)** (87⭐): 2026 年 AI Agent 精选列表，含物流运输相关资源
- **[NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)** (170k⭐): Hermes Agent：Nous Research 出品的开源 AI Agent 框架
- **[langgenius/dify](https://github.com/langgenius/dify)** (142k⭐): 生产级 Agentic 工作流开发平台，支持 RAG 管道和多模型
- **[langchain-ai/langchain](https://github.com/langchain-ai/langchain)** (138k⭐): 构建多智能体系统、工具调用 Agent、RAG 管道的事实标准框架
- **[open-webui/open-webui](https://github.com/open-webui/open-webui)** (138k⭐): 开源 AI 交互界面，支持 MCP 工具集成
- **[anthropics/claude-code](https://github.com/anthropics/claude-code)** (127k⭐): Anthropic 出品的 AI 编码 Agent，支持 Skills 系统
- **[lobehub/lobe-chat](https://github.com/lobehub/lobe-chat)** (77k⭐): 开源 LLM 聊天框架，支持插件市场和 Agent 工作流
